        ...
        <div class="u-form u-form-1">
          <form  method="POST" action="nouveauMdp.php" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" source="email" name="form" style="padding: 10px;">
            <div class="u-form-group u-form-name">
              ...
              <input type="email" placeholder="Saisir votre adresse mail" id="name-c594" name="mdp" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-radius-50 u-white" required="">
            </div>
