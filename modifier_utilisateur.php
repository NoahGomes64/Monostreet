...
<form method="post" action="modifier_utilisateur.php">
    ...
    <select name="role">
        <option value="admin" <?php if ($user['estPrivilegie'] == 1) echo 'selected'; ?>>Administrateur</option>
        <option value="user" <?php if ($user['estPrivilegie'] == 'user') echo 'selected'; ?>>Utilisateur</option>
    </select>
