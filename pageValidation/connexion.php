    ...
    try {
      ...
      if ($stmt->rowCount() > 0) {
        ...
        if (password_verify($_POST['mdp'], $hash[0])) {
          ...
          $_SESSION['id'] =  $id[0];
          $requete=$connection->prepare("UPDATE compte SET validationInscription=1 WHERE nom = :nom");
          $requete->bindParam(':nom', $Pseudo, PDO::PARAM_STR);
          $requete->execute();
...
borders: top right bottom left !important; border-color: #404040 !important; border-width: 2px !important
    ...
    <section class="u-align-left u-clearfix u-image u-shading u-section-1" src="" data-image-width="1503" data-image-height="1000" id="sec-864e">
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <h3 class="u-text">Veuillez vous reconnecter pour valider votre email sur MONOSTREET ! </h3>
