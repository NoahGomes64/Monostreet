...
function jeuMonostreet(nbJoueur, listeDesRues){
    ...
    //Creation du Plateau
    var plateau = [new CaseNonAchetable(0,"Depart"), new CasePropriete(1, listeDesRues[0], 200), new CaseCarteChance(2, "chance"), new CasePropriete(3, "case3"),
  new CaseNonAchetable(4, "Rien"), new CaseGare(5, "gare de lyon"), new CasePropriete(6, "Case6"), new CaseCarteChance(7,"Chance"),
  new CasePropriete(8, "Case8"), new CasePropriete(9, "Case9"), new CaseNonAchetable(10, "Prison"), new CaseNonAchetable(11, "Prison"),
  new CasePropriete(12, "Case8"), new CasePropriete(13, "Case9"), new CaseNonAchetable(14, "Prison"), new CaseNonAchetable(15, "Prison"),
  new CasePropriete(16, "Case8"), new CasePropriete(17, "Case9"), new CaseNonAchetable(18, "Prison"), new CaseNonAchetable(19, "Prison"),
  new CasePropriete(20, "Case8"), new CasePropriete(21, "Case9"), new CaseNonAchetable(22, "Prison"), new CaseNonAchetable(23, "Prison"),
  new CasePropriete(24, "Case8"), new CasePropriete(25, "Case9"), new CaseNonAchetable(26, "Prison"), new CaseNonAchetable(27, "Prison"),
  new CasePropriete(28, "Case8"), new CasePropriete(29, "Case9"), new CaseNonAchetable(30, "Prison"), new CaseNonAchetable(31, "Prison"),
  new CasePropriete(32, "Case8"), new CasePropriete(33, "Case9"), new CaseNonAchetable(34, "Prison"), new CaseNonAchetable(35, "Prison"),
  new CasePropriete(36, "Case8"), new CasePropriete(37, "Case9"), new CaseNonAchetable(38, "Prison"), new CaseNonAchetable(39, "Prison"),];
